...
public class WashingMachine extends HouseholdAppliances implements Serializable
{
    private String name;
    ...
    public WashingMachine(float power_consumption, float weight, int electricCurrent, String name, int washCycle)
    {
